package com.ey.movieapp.domain
...
data class ResultsItem(
    ...
    @field:SerializedName("original_title") val originalTitle: String? = null,
    ...
    @field:SerializedName("popularity") val popularity: Any? = null,
    @field:SerializedName("vote_average") val voteAverage: Any? = null,
